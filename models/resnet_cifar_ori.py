...
def resnet18_cifar_ori(**kwargs):
    return ResNet(BasicBlock, [2, 2, 2, 2], **kwargs)


def resnet34_cifar_ori(**kwargs):
    return ResNet(BasicBlock, [3, 4, 6, 3], **kwargs)


def resnet50_cifar_ori(**kwargs):
    return ResNet(Bottleneck, [3, 4, 6, 3], **kwargs)


def resnet101_cifar_ori(**kwargs):
    return ResNet(Bottleneck, [3, 4, 23, 3], **kwargs)


def resnet152_cifar_ori(**kwargs):
...
if __name__ == "__main__":
    ...
    model = resnet18_cifar_ori(num_classes=10, ratio=1.0)
