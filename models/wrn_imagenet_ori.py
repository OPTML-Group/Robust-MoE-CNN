...
class WideResNet(nn.Module):
    def __init__(
        ...
        self.conv1 = torch.nn.Conv2d(3, int(nChannels[0] * self.ratio), kernel_size=7, stride=2, padding=3, bias=False)
