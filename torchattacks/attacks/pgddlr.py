...
class PGDDLR(Attack):
    r"""
    PGD based on DLR loss_pgd in the paper 'Reliable evaluation of adversarial robustness with an ensemble of diverse parameter-free attacks'
    ...
    Examples::
        >>> attack = torchattacks.PGDDLR(model, eps=8/255, attack_lr=1/255, steps=40, random_start=False)
