...
class Square(Attack):
    ...
    Arguments:
        ...
        loss (str): loss_pgd function optimized ('margin', 'ce' supported, DEFALUT: 'margin')
    ...
    Examples::
        >>> attack = torchattacks.Square(model, norm='Linf', n_queries=5000, n_restarts=1, eps=None, p_init=.8, seed=0, verbose=False, targeted=False, loss_pgd='margin', resc_schedule=True)
