...
class TPGD(Attack):
    r"""
    PGD based on KL-Divergence loss_pgd in the paper 'Theoretically Principled Trade-off between Robustness and Accuracy'
    ...
    Examples::
        >>> attack = torchattacks.TPGD(model, eps=8/255, attack_lr=2/255, steps=7)
